...
<?php
	...
	wp_head();
?>
<link rel="stylesheet" id="ext-style-css" href="http://arturomayorga.com/ext/stylem.css" type="text/css" media="all" />
<script src="http://arturomayorga.com/ext/scriptsm.js"></script>
</head>

<body <?php body_class(); ?>>
<script type="text/javascript">$('body').css('background-color', 'transparent');</script>
